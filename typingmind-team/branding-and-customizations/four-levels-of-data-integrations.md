...
![RAG Definition](/images/RAG-definition.webp)

_Diagram that RAG uses semantic search to retrieve relevant and timely context that LLMs use to produce more accurate responses. Source: [Pinecone](https://www.pinecone.io/learn/retrieval-augmented-generation/)_
...
<Tip>
  You can learn more details on RLHF [here](https://aws.amazon.com/what-is/reinforcement-learning-from-human-feedback/)
</Tip>
...
**Send us an email to [support@typingmind.com](mailto:support@typingmind.com) if you need any further assistance!**