...
With TypingMind Teams, you can restrict the visibility of prompts for certain user groups. This allows you to control which prompts each user group can be used.
