...
| Cloud sync and backup | <Icon icon="check" color="#16a34a" /><br />Unlimited storage | — |
...
| Multilingual support | <Icon icon="check" color="#16a34a" /> | <Icon icon="check" color="#16a34a" /> |
...
| Google Gemini (Gemini 1.5 Pro) | <Icon icon="check" color="#16a34a" /> | <Icon icon="check" color="#16a34a" /> |
| Azure OpenAI | <Icon icon="check" color="#16a34a" /> | <Icon icon="check" color="#16a34a" /> |
| Perplexity | <Icon icon="check" color="#16a34a" /> | <Icon icon="check" color="#16a34a" /> |
| OpenRouter | <Icon icon="check" color="#16a34a" /> | <Icon icon="check" color="#16a34a" /> |
| Groq API | <Icon icon="check" color="#16a34a" /> | <Icon icon="check" color="#16a34a" /> |
| Mistral AI | <Icon icon="check" color="#16a34a" /> | <Icon icon="check" color="#16a34a" /> |
| Other open-source models | <Icon icon="check" color="#16a34a" /> | <Icon icon="check" color="#16a34a" /> |
...
| Role-based access control | <Icon icon="check" color="#16a34a" /> | — |
| Token usage analytics | <Icon icon="check" color="#16a34a" /> | — |
| Per-user usage limits | <Icon icon="check" color="#16a34a" /> | — |
| Connect training data | <Icon icon="check" color="#16a34a" /><br />More flexible | <Icon icon="check" color="#16a34a" /> |
...
| Manage chats by folders or tags | <Icon icon="check" color="#16a34a" /> | — |
| Search chats | <Icon icon="check" color="#16a34a" /> | <Icon icon="check" color="#16a34a" /> |
| Archive chats | <Icon icon="check" color="#16a34a" /> | <Icon icon="check" color="#16a34a" /> |
| Bulk actions (delete, move, archive) | <Icon icon="check" color="#16a34a" /> | — |
| Build prompt & AI Agent collection | <Icon icon="check" color="#16a34a" /> | <Icon icon="check" color="#16a34a" /> |
| Fork chats / branching | <Icon icon="check" color="#16a34a" /> | <Icon icon="check" color="#16a34a" /> |
| Chat title generator | <Icon icon="check" color="#16a34a" /> | <Icon icon="check" color="#16a34a" /> |
| Custom instructions | <Icon icon="check" color="#16a34a" /> | <Icon icon="check" color="#16a34a" /> |
| Switch AI models mid-chat | <Icon icon="check" color="#16a34a" /> | <Icon icon="check" color="#16a34a" /> |
| User profiles | <Icon icon="check" color="#16a34a" /><br />Multiple profiles | — |
| Token count and cost estimation | <Icon icon="check" color="#16a34a" /> | — |
| Custom parameters per model | <Icon icon="check" color="#16a34a" /> | <Icon icon="check" color="#16a34a" /> |
| Keyboard shortcuts | <Icon icon="check" color="#16a34a" /> | — |
| Share chats | <Icon icon="check" color="#16a34a" /> | — |
| Import / Export chats | <Icon icon="check" color="#16a34a" /> | <Icon icon="check" color="#16a34a" /> |
...
| Code interpreter (advanced data analysis) | — Coming soon | <Icon icon="check" color="#16a34a" /> |
| Image generator | <Icon icon="check" color="#16a34a" /><br />Grok, DALL-E, Stable Diffusion | <Icon icon="check" color="#16a34a" /> |
| Plugin store | <Icon icon="check" color="#16a34a" /><br />Continuously expanding | <Icon icon="check" color="#16a34a" /> |
| [Build your own plugin](https://docs.typingmind.com/plugins/build-a-typingmind-plugin) | <Icon icon="check" color="#16a34a" /> | — |
...
| Shared plugins | <Icon icon="check" color="#16a34a" /> | — |
...
| JWT Secret | <Icon icon="check" color="#16a34a" /> | <Icon icon="check" color="#16a34a" /> |
