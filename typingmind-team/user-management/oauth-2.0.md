...
7. You can use the `access_token` (or `id_token`) via plugins using a special parameter in the plugin’s code, see the [**TypingMind Plugins**](../../Plugins/Build%20a%20TypingMind%20Plugin%207ecc24adfcde4443b37ce7e4aea73b05.md) for more details.