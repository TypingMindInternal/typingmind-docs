...
1. **Create a Shared Connection**:
   ...
   - Click **"Add New Connection"** to create a new OAuth connection <img src="build-a-typingmind-plugin/image%208.png" alt="image.png" />
2. **Configure OAuth Credentials**:
   - Enter necessary details such as Authorization URL, Token URL, Client ID, Client Secret, Scopes, Prompt, and Access Type <img src="build-a-typingmind-plugin/image%209.png" alt="image.png" />
3. **Apply Shared OAuth to Plugins**:
   ...
   - Plugin credentials will automatically apply from the shared connection—no further setup required <img src="build-a-typingmind-plugin/image%2010.png" alt="image.png" /> <img src="build-a-typingmind-plugin/image%2011.png" alt="image.png" />
