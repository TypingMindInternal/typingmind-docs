...
[Build a TypingMind Plugin](/plugins/build-a-typingmind-plugin)

[User-contributed Plugins](/plugins/user-contributed-plugins)

[Share / Import plugins](/plugins/share-import-plugins)
...
[Create a Plugin Server URL](/plugins/create-a-plugin-server-url)

[TypingMind Plugin JSON Schema](/plugins/typingmind-plugin-json-schema)
...
[**Send Emails via Zapier**](/plugins/send-emails-via-zapier)

[Powerpoint Generator](/plugins/powerpoint-generator)

[Word Generator](/plugins/word-generator)

## Plugin Development Tutorials

[Google Calendar ](/plugins/google-calendar)

[Slack Message Notifier](/plugins/slack-message-notifier)

[Spotify Song Suggestions](/plugins/spotify-song-suggestions)