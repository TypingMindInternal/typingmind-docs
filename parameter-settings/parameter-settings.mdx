...
<Note>
  ...
  Please note: You also have the option to set up custom parameters for each AI model. [Learn more](/parameter-settings/custom-parameters-for-each-model)

</Note>

![image.webp](parameter-settings/image.webp)
...
![Untitled](parameter-settings/Untitled.webp)
...
![Untitled](parameter-settings/Untitled%201.webp)
...
![Untitled](parameter-settings/Untitled%202.webp)
...
![Untitled](parameter-settings/Untitled%203.webp)
...
![Untitled](parameter-settings/Untitled%204.webp)
...
![Untitled](parameter-settings/Untitled%205.webp)
...
![Untitled](parameter-settings/Untitled%206.webp)
...
![Untitled](parameter-settings/Untitled%207.webp)
