...
![Untitled](Share%20Export%20chats/Untitled.webp)
...
![Untitled](Share%20Export%20chats/Untitled%201.webp)

3. Choose your **expected sharing/exporting format**:
    - Unique link via Secret Link (TypingMind Cloud) or ShareGPT
    - Text, HTML, PDF
    - JSON (used to build fine-tuning model)

![Untitled](Share%20Export%20chats/Untitled%202.webp)

4. If you share your chat via a unique link, just simply copy the link and share with everyone!

If you share with other formats, just copy and download the file based on different formats.

![Untitled](Share%20Export%20chats/Untitled%203.webp)