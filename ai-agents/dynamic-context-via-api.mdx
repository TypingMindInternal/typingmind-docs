...
![Dynamic Context Api](/images/dynamic-context-api.webp)
...
For [Project Folders](/chat-management/project-folders):
...
Compared to [the knowledge base (TypingMind Custom](/typingmind-team/branding-and-customizations/how-knowledge-base-works-in-typingmind-team)), the Dynamic Context will inject the content directly into the AI Agent/Project Context. This means the AI will not need to perform a lookup in order to get the desired content.
