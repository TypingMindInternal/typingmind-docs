...
![image.webp](connect-to-llamaindex/image.webp)
...
![image.webp](connect-to-llamaindex/image%201.webp)

1. Connect your index to your data sources (e.g., Google Drive, Notion, databases, and more)
...
![image.webp](connect-to-llamaindex/image%202.webp)
...
![image.webp](connect-to-llamaindex/image%203.webp)
...
![image.webp](connect-to-llamaindex/image%204.webp)

If you choose to run the MCP servers on your device, run the command displayed on the screen.

![image.webp](connect-to-llamaindex/image%205.webp)
...
![image.webp](connect-to-llamaindex/image%206.webp)
...
![image.webp](connect-to-llamaindex/image%207.webp)