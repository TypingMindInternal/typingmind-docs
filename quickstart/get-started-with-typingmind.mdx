...
You can disable sync at any time by logging out, or connect your own cloud storage via [TypingMind Extensions](https://docs.typingmind.com/typing-mind-extensions). Learn more in [Cloud Sync & Backup](/cloud-sync-and-backup).
