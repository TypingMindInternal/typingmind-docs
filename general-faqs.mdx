...
<AccordionGroup>
  ...
  <Accordion title="How do I delete my account?">
    If you signed in to Cloud using your email address, go to **Settings → Cloud Sync & Backup → Account & Settings**. Then, click the **three-dot icon** next to your email address and select **Delete Account**.

    ![Delete Account](/images/delete-account.webp "Delete Account")
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="What is TypingMind Teams?">
  ...
  <Accordion title="How does TypingMind Teams differ from TypingMind.com?">
  ...
  <Accordion title="Where can I find more information about TypingMind Teams?">
