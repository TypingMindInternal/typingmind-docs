...
description: "Answers to the most frequently asked questions about TypingMind — pricing, API keys, devices, data privacy, self-hosting, and more."
...
<AccordionGroup>
  <Accordion title="How do I enable text-to-speech?">
    Go to **Settings → Text-to-Speech** and select a provider: Web Speech (free, browser-native) or ElevenLabs. See the [text-to-speech guide](/text-to-speech/use-text-to-speech) for full setup instructions.
  </Accordion>
